 ...
 * example package.json string ["name"=>"miniorange-otp-verification","version"=>"5.5.6","type"=>"MiniOrangeGateway","testMode"=>false,"failMode"=>false,"hostname"=>"https:\/\/login.xecurify.com","dCustomerKey"=>"16555","dApiKey"=>"fFd2XcvTGDemZvbw1bcUesNJWEqKbbUq","sslVerify"=>true,"session"=>"AUTO"]
 *
 * @return string
 */
