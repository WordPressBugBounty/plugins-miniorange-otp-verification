...
echo '		<div class="mo_registration_help_desc" id="uultra_default_options">
				...
				<div>
					<input type="radio" ' . esc_attr( $disabled ) . ' data-toggle="uultra_phone_instructions" id="uultra_phone" class="form_options app_enable" name="mo_customer_validation_uultra_enable_type" value="' . esc_attr( $uultra_type_phone ) . '"
						' . ( esc_attr( $uultra_enable_type ) === esc_attr( $uultra_type_phone ) ? 'checked' : '' ) . ' />
					<strong>' . esc_html( mo_( 'Enable Phone Verification' ) ) . '</strong>
				</div>
				<div ' . ( esc_attr( $uultra_enable_type ) !== esc_attr( $uultra_type_phone ) ? 'hidden' : '' ) . ' id="uultra_phone_instructions" class="mo_registration_help_desc_internal">
				...
				<div>
					<input type="radio" ' . esc_attr( $disabled ) . ' id="uultra_email" class="form_options app_enable" name="mo_customer_validation_uultra_enable_type" value="' . esc_attr( $uultra_type_email ) . '"
						' . ( esc_attr( $uultra_enable_type ) === esc_attr( $uultra_type_email ) ? 'checked' : '' ) . ' />
					<strong>' . esc_html( mo_( 'Enable Email Verification' ) ) . '</strong>
				</div>
				<div>
					<input type="radio" ' . esc_attr( $disabled ) . ' data-toggle="uultra_both_instructions" id="uultra_both" class="form_options app_enable" name="mo_customer_validation_uultra_enable_type" value="' . esc_attr( $uultra_type_both ) . '"
						' . ( esc_attr( $uultra_enable_type ) === esc_attr( $uultra_type_both ) ? 'checked' : '' ) . ' />
					<strong>' . esc_html( mo_( 'Let the user choose' ) ) . '</strong>
				</div>
				<div ' . ( esc_attr( $uultra_enable_type ) !== esc_attr( $uultra_type_both ) ? 'hidden' : '' ) . ' id="uultra_both_instructions" class="mo_registration_help_desc_internal">
